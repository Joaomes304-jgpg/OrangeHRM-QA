...
Siga as instruções abaixo no seu terminal para configurar o ambiente:

### 1. Clonar o Repositório
```bash
git clone [https://github.com/Joaomes304-jgpg/OrangeHRM-QA.git](https://github.com/Joaomes304-jgpg/OrangeHRM-QA.git)
